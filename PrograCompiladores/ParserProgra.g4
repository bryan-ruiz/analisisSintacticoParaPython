...
program:
        statement (statement)*                                      #programStatement
        ;
...
comparison:
        ((MENQ|MAYQ|MENIG|MAYIG|CMPIG|CMPDIF) additionExpression)*  #comparisonRule
        ;
...
multiplicationFactor:
        ((MUL|DIV) multiplicationExpression)*                       #multiplicationFactorRule
        ;
...
primitiveExpression:
    ...
    |STRING                                                         #primitiveExpressionString
...
listExpression:
        PCIRIZQ expressionList PCIRDER                              #listExpressionRule
        ;
